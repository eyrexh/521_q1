...
<https://github.ubc.ca/MDS-2022-23/DSCI_551_lab4_eyrexh>
...
https://github.com/eyrexh/521_q1
...
```{r answer4, highlight = TRUE}
a_4 <- c("option 'highlight = TRUE' can highlight the code")
```
...
```{r answer5, comment = '', results = "hide"}
a_5 <- c("option comment = '' will remove the default text output starting with ##", "option results = hide will hide the text result")
```
...
**Answer**
q7_Rmd: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_eyrexh/blob/master/q7_Rmarkdown.Rmd

q7_html: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_eyrexh/blob/master/q7_Rmarkdown.html

q7_pdf: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_eyrexh/blob/master/q7_Rmarkdown.pdf
...
q8_Rmarkdown: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_eyrexh/blob/master/q8_Rmarkdown.Rmd

q8_html: https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_eyrexh/blob/master/q8_Rmarkdown.html
...
**Answer**
https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_eyrexh/blob/master/q8_Rmarkdown.md

We can edit the cell directly on the GitHub. When I render it, it replace the old `html` file and creat a `md` file.
...
edgerunners.Rmd: https://github.com/eyrexh/521_q1/blob/master/edgerunners.Rmd

edgerunner.html: https://github.com/eyrexh/521_q1/blob/master/edgerunners.html
...
The reproductible tools like R Markdown and Jupyter can edit on the raw file and render to different formats of files. Every time they render a new file, it will automatically replace the previous same format files. They are easy to produce in different file formats, and good for checking the updated one. However, they are more complicated to use, and require more memory space to save the file. You cannot find the previous render version files, but need to check and undo the editing in the raw file.

The non-reproducible tools like Word and Powerpoint normally will be read in their own format. They cannot render to a lot of different formats. It will export a new file every time you require to save and export the file in a different formats. This can make you easy to track the previous files versions. Also, they are wasy to use and edit it. However, they are basic editing software that does not contain many various features that allow the users to manipulate by themselves.
